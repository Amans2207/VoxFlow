    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', opacity: videoId ? 1 : 0.6 }}>
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        <button 
          ...
          style={{ flex: 2, height: '44px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', opacity: videoId ? 1 : 0.5, cursor: videoId ? 'pointer' : 'not-allowed' }}
        >
