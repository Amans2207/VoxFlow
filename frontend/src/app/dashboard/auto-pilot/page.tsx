              ...
              <div className="flex flex-col gap-8">
                 <div className="p-8 lg:p-10 bg-[#0A0A0B] rounded-[48px] border border-white/5 shadow-2xl">
                  ...
                  <button 
                    ...
                    className={`h-16 w-full ${isProcessing || clips.length === 0 ? 'bg-white/5 text-[#262626] cursor-not-allowed' : 'bg-[#00f2ff] text-black cursor-pointer hover:shadow-[0_20px_40px_rgba(0,242,255,0.2)]'} font-black rounded-2xl text-[11px] uppercase tracking-[4px] border-none active:scale-95 transition-all`}
                  >
                    {isProcessing ? "Launching..." : "Launch Orchestration"}
                  </button>
              </div>
           </motion.div>
         ) : (
